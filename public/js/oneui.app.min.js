        ...
        return r = e, null, (l = [{
            ...
            key: "coreScrollTo", value: function () {
                jQuery('[data-toggle="scroll-to"]:not(.js-scroll-to-enabled)').on("click.pixelcave.helpers.core", (function (e) {
                    e.stopPropagation();
                    var a = jQuery("#page-header"), t = jQuery(e.currentTarget), o = t.data("target") || t.attr("href"),
                        n = t.data("speed") || 1e3,
            ...
            key: "coreAppear", value: function () {
                jQuery('[data-toggle="appear"]:not(.js-appear-enabled)').each((function (e, t) {
                    var o = a.getWidth(), n = jQuery(t), r = n.data("class") || "animated fadeIn",
                        l = n.data("offset") || 0, i = o < 992 ? 0 : n.data("timeout") ? n.data("timeout") : 0;
                ...
                jQuery(".js-table-checkable:not(.js-table-checkable-enabled)").each((function (a, t) {
                    ...
                    o.addClass("js-table-checkable-enabled"), jQuery("thead input:checkbox", o).on("click.pixelcave.helpers", (function (a) {
                        ...
                        if (!("checkbox" === a.target.type || "button" === a.target.type || "a" === a.target.tagName.toLowerCase() || jQuery(a.target).parent("a").length || jQuery(a.target).parent("button").length || jQuery(a.target).parent(".custom-control").length || jQuery(a.target).parent("label").length)) {
                            var t = jQuery("input:checkbox", a.currentTarget), n = t.prop("checked");
            ...
            key: "sparkline", value: function () {
                ...
                jQuery(".js-sparkline:not(.js-sparkline-enabled)").each((function (a, t) {
                    var r = jQuery(t), l = r.data("type"), i = {}, s = {
                        line: function () {
            ...
            key: "flatpickr", value: function (e) {
                function a() {
    ...
    var u = function (e) {
        ...
        return t = e, (o = [{
            ...
            key: "_uiHandleTheme", value: function () {
                var e = jQuery("#css-theme"), t = !!this._lPage.hasClass("enable-cookies");
                if (t) {
                ...
                jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').addClass("active"), this._lPage.off("click.pixelcave.themes"), this._lPage.on("click.pixelcave.themes", '[data-toggle="theme"]', (function (o) {
                    o.preventDefault();
                    var n = jQuery(o.currentTarget), r = n.data("theme");
                    jQuery('[data-toggle="theme"]').removeClass("active"), jQuery('[data-toggle="theme"][data-theme="' + r + '"]').addClass("active"), a.updateTheme(e, r), e = jQuery("#css-theme"), t && Cookies.set("oneuiThemeName", r, {expires: 7}), n.trigger("blur")
                }))
            }
        }, {
            key: "_uiApiLayout", value: function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "init", t = this;
            ...
            key: "_uiApiBlocks", value: function () {
                var e, a, t, o = this, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "init",
                    ...
                    i = "si si-size-fullscreen", s = "si si-size-actual", c = "si si-arrow-up", d = "si si-arrow-down",
                    u = {
                        init: function () {
